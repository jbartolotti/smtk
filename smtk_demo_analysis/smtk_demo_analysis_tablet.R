...
# Demo Data Analysis
data_dir <- file.path('smtk_demo_data','tablet','9998')
...
mydata <- procOneP.Tablet('9998', tablet_dat,
                          figdir = file.path('smtk_demo_results','tablet','figures','9998'),
                          resultsdir = file.path('smtk_demo_results','tablet','results','9998'),
                          config = config)
